    ...
    try {
      ...
      const templateData = {
        ...
        actionUrl: notification.metadata?.actionUrl ?
          `${process.env.CLIENT_URL}${notification.metadata.actionUrl}` : null,
        priorityClass: notification.priority === 'HIGH' ? 'priority-high' :
          notification.priority === 'URGENT' ? 'priority-urgent' : '',
        ...notification.data
      };
