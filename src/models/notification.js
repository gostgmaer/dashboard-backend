...
const notificationTypeGroups = {
  ...
  ORDER: ['ORDER_CREATED', 'ORDER_UPDATED', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'ORDER_CANCELLED', 'ORDER_RETURNED', 'ORDER_REFUNDED', 'ORDER_DELAYED', 'ORDER_PAYMENT_PENDING', 'ORDER_PAYMENT_FAILED', 'ORDER_PAYMENT_SUCCESS', 'ORDER_REVIEWED', 'ORDER_DISPUTED', 'ORDER_PARTIALLY_SHIPPED', 'ORDER_PARTIALLY_RETURNED'],
  PAYMENT: ['PAYMENT_SUCCESS', 'PAYMENT_FAILED', 'PAYMENT_REFUNDED', 'INVOICE_GENERATED', 'INVOICE_PAID', 'INVOICE_OVERDUE', 'CHARGEBACK_INITIATED', 'CHARGEBACK_RESOLVED'],
  ...
  SYSTEM: ['SYSTEM_ALERT', 'MAINTENANCE_SCHEDULED', 'MAINTENANCE_STARTED', 'MAINTENANCE_COMPLETED', 'NEW_FEATURE_RELEASED', 'BUG_FIX_DEPLOYED', 'SYSTEM_ERROR', 'SECURITY_ALERT', 'DATA_BACKUP_COMPLETED', 'API_RATE_LIMIT_EXCEEDED', 'UNEXPECTED_SHUTDOWN', 'SERVER_RESTARTED'],
  ...
  MARKETING: ['NEWSLETTER_SUBSCRIBED', 'PROMOTIONAL_OFFER', 'LOYALTY_POINTS_EARNED', 'LOYALTY_POINTS_REDEEMED', 'SURVEY_REQUEST', 'EVENT_INVITATION', 'WEBINAR_REMINDER', 'REFERRAL_BONUS_EARNED'],
