...
const notificationTypeGroups = {
  ...
  // 👤 USER & ACCOUNT
  // ==============================
  USER: ['USER_CREATED', 'USER_UPDATED', 'USER_DELETED', 'USER_SUSPENDED', 'USER_REINSTATED', 'ROLE_ASSIGNED', 'ROLE_REVOKED', 'PERMISSION_CHANGED', 'PASSWORD_CHANGED', 'PASSWORD_RESET_REQUESTED', 'PASSWORD_RESET_COMPLETED', 'PASSWORD_EXPIRED', 'EMAIL_VERIFIED', 'PHONE_VERIFIED', 'PROFILE_COMPLETED', 'PROFILE_PICTURE_UPDATED', 'LOGIN_SUCCESS', 'LOGIN_FAILED', 'NEW_DEVICE_LOGIN', 'ACCOUNT_LOCKED', 'ACCOUNT_UNLOCKED', 'ACCOUNT_RECOVERY_REQUESTED', 'ACCOUNT_RECOVERY_COMPLETED', 'CONSENT_REQUIRED', 'CONSENT_REVOKED', 'ACCOUNT_MERGED', 'ACCOUNT_TERMINATED', 'SOCIAL_LOGIN_CONNECTED', 'SOCIAL_LOGIN_DISCONNECTED', 'MFA_ENABLED', 'MFA_DISABLED', 'SESSION_EXPIRED', 'PRIVACY_POLICY_UPDATED', 'TERMS_OF_SERVICE_UPDATED'],

  // ==============================
  // 🏢 ORGANIZATION & TEAM
  // ==============================
  ORGANIZATION: ['ORG_CREATED', 'ORG_UPDATED', 'ORG_DELETED', 'ORG_PLAN_CHANGED', 'ORG_MEMBER_INVITED', 'ORG_MEMBER_REMOVED', 'ORG_ROLE_ASSIGNED', 'ORG_ROLE_CHANGED', 'ORG_ROLE_REVOKED', 'ORG_SECURITY_POLICY_UPDATED', 'ORG_API_KEY_CREATED', 'ORG_API_KEY_REVOKED', 'ORG_DOMAIN_VERIFIED', 'ORG_DOMAIN_UNVERIFIED', 'ORG_BILLING_UPDATED', 'ORG_COMPLIANCE_AUDIT_COMPLETED'],

  // ==============================
  // 💳 PAYMENT & BILLING
  // ==============================
  PAYMENT: ['PAYMENT_SUCCESS', 'PAYMENT_FAILED', 'PAYMENT_PENDING', 'PAYMENT_REFUNDED', 'INVOICE_GENERATED', 'INVOICE_PAID', 'INVOICE_OVERDUE', 'INVOICE_CANCELLED', 'BILLING_INFO_UPDATED', 'AUTO_RENEWAL_REMINDER', 'SUBSCRIPTION_STARTED', 'SUBSCRIPTION_CANCELLED', 'SUBSCRIPTION_RENEWED', 'CHARGEBACK_INITIATED', 'CHARGEBACK_RESOLVED'],

  // ==============================
  // 💰 FINANCE / ACCOUNTING
  // ==============================
  FINANCE: ['EXPENSE_CREATED', 'EXPENSE_APPROVED', 'EXPENSE_REJECTED', 'BUDGET_UPDATED', 'BUDGET_EXCEEDED', 'VENDOR_PAYMENT_INITIATED', 'VENDOR_PAYMENT_COMPLETED', 'TAX_DOCUMENT_SUBMITTED', 'REIMBURSEMENT_APPROVED', 'FINANCIAL_AUDIT_COMPLETED'],

  // ==============================
  // 🛒 SHOPPING
  // ==============================
  SHOPPING: ['CART_CREATED', 'CART_UPDATED', 'CART_ABANDONED', 'WISHLIST_CREATED', 'WISHLIST_REMINDER', 'WISHLIST_PRICE_DROP', 'WISHLIST_BACK_IN_STOCK', 'CART_ITEM_PRICE_CHANGED', 'CART_EXPIRY_NOTIFICATION'],

  // ==============================
  // 📦 ORDER & DELIVERY
  // ==============================
  ORDER: ['ORDER_CREATED', 'ORDER_CONFIRMED', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'ORDER_DELAYED', 'ORDER_CANCELLED', 'ORDER_RETURNED', 'ORDER_REFUNDED', 'ORDER_PAYMENT_PENDING', 'ORDER_PAYMENT_FAILED', 'ORDER_PARTIALLY_SHIPPED', 'CUSTOM_ORDER_CONFIRMED', 'ORDER_REVIEWED'],

  // ==============================
  // 🔁 RETURN / EXCHANGE
  // ==============================
  RETURN: ['RETURN_REQUEST_RECEIVED', 'RETURN_APPROVED', 'RETURN_REJECTED', 'RETURN_COMPLETED', 'EXCHANGE_REQUESTED', 'EXCHANGE_APPROVED', 'EXCHANGE_REJECTED'],

  // ==============================
  // ⚙️ SYSTEM / INFRASTRUCTURE
  // ==============================
  SYSTEM: ['SYSTEM_ALERT', 'MAINTENANCE_SCHEDULED', 'MAINTENANCE_STARTED', 'MAINTENANCE_COMPLETED', 'DATA_BACKUP_COMPLETED', 'SERVER_RESTARTED', 'SERVER_OVERLOADED', 'DEPLOYMENT_STARTED', 'DEPLOYMENT_COMPLETED', 'DEPLOYMENT_FAILED', 'CONFIGURATION_CHANGED', 'SERVICE_OUTAGE_DETECTED', 'SERVICE_RECOVERED', 'NEW_FEATURE_RELEASED'],

  // ==============================
  // 🧠 WORKFLOW / AUTOMATION
  // ==============================
  WORKFLOW: ['TASK_CREATED', 'TASK_ASSIGNED', 'TASK_COMPLETED', 'TASK_OVERDUE', 'TASK_COMMENT_ADDED', 'WORKFLOW_TRIGGERED', 'WORKFLOW_COMPLETED', 'WORKFLOW_FAILED', 'APPROVAL_REQUESTED', 'APPROVAL_GRANTED', 'APPROVAL_DENIED'],

  // ==============================
  // 💬 COMMUNICATION
  // ==============================
  COMMUNICATION: ['MESSAGE_SENT', 'MESSAGE_RECEIVED', 'MESSAGE_READ', 'MENTION_RECEIVED', 'COMMENT_POSTED', 'COMMENT_REPLIED', 'EMAIL_DELIVERED', 'EMAIL_FAILED', 'PUSH_NOTIFICATION_SENT', 'CHAT_STARTED', 'CHAT_ENDED'],

  // ==============================
  // 🧑‍💻 DEVELOPER / INTEGRATIONS
  // ==============================
  DEVELOPER: ['API_KEY_CREATED', 'API_KEY_REVOKED', 'WEBHOOK_REGISTERED', 'WEBHOOK_FAILED', 'WEBHOOK_RETRY', 'APP_INSTALLED', 'APP_UNINSTALLED', 'INTEGRATION_CONNECTED', 'INTEGRATION_DISCONNECTED', 'BUILD_STARTED', 'BUILD_FAILED', 'BUILD_SUCCEEDED', 'SANDBOX_DEPLOYED', 'SANDBOX_RESET'],

  // ==============================
  // 📊 ANALYTICS & INSIGHTS
  // ==============================
  ANALYTICS: ['DAILY_REPORT_READY', 'WEEKLY_REPORT_READY', 'MONTHLY_REPORT_READY', 'DATA_TREND_ALERT', 'TRAFFIC_SPIKE', 'CONVERSION_RATE_DROP', 'ENGAGEMENT_INCREASED', 'KPI_THRESHOLD_BREACHED'],

  // ==============================
  // 🧾 COMPLIANCE / LEGAL / AUDIT
  // ==============================
  COMPLIANCE: ['GDPR_EXPORT_REQUESTED', 'GDPR_DELETE_REQUESTED', 'DATA_BREACH_ALERT', 'AUDIT_LOG_GENERATED', 'LEGAL_HOLD_INITIATED', 'LEGAL_HOLD_RELEASED', 'SECURITY_AUDIT_COMPLETED', 'PRIVACY_POLICY_UPDATED', 'TERMS_OF_SERVICE_UPDATED'],

  // ==============================
  // 🚚 SHIPPING & LOGISTICS
  // ==============================
  SHIPPING: ['PACKAGE_DISPATCHED', 'PACKAGE_IN_TRANSIT', 'PACKAGE_OUT_FOR_DELIVERY', 'PACKAGE_DELIVERED', 'PACKAGE_DELAYED', 'PACKAGE_LOST', 'DELIVERY_EXCEPTION', 'CUSTOMS_HOLD'],

  // ==============================
  // 🎯 MARKETING & PROMOTIONS
  // ==============================
  MARKETING: ['PROMOTION_LAUNCHED', 'DISCOUNT_APPLIED', 'FLASH_SALE_ANNOUNCEMENT', 'LOYALTY_POINTS_EARNED', 'LOYALTY_POINTS_REDEEMED', 'NEW_PRODUCT_LAUNCH', 'CUSTOMER_MILESTONE', 'REVIEW_REMINDER', 'EVENT_INVITATION', 'HOLIDAY_GREETINGS'],

  // ==============================
  // 🧾 PRODUCT & INVENTORY
  // ==============================
  PRODUCT: ['PRODUCT_CREATED', 'PRODUCT_UPDATED', 'PRODUCT_DELETED', 'PRODUCT_FEATURED', 'PRODUCT_BACK_IN_STOCK', 'PRODUCT_REVIEWED', 'PRODUCT_OUT_OF_STOCK', 'PRODUCT_ARCHIVED'],

  INVENTORY: ['STOCK_LOW', 'STOCK_CRITICAL', 'STOCK_REPLENISHED', 'INVENTORY_AUDIT_COMPLETED', 'SUPPLIER_DELAY', 'BATCH_EXPIRING_SOON', 'WAREHOUSE_TRANSFER_INITIATED'],

  // ==============================
  // 🏥 HEALTHCARE / WELLNESS
  // ==============================
  HEALTH: ['APPOINTMENT_BOOKED', 'APPOINTMENT_CANCELLED', 'DOCTOR_ASSIGNED', 'PRESCRIPTION_READY', 'TEST_RESULT_AVAILABLE', 'VACCINATION_REMINDER', 'HEALTH_REPORT_UPLOADED', 'FITNESS_GOAL_COMPLETED'],

  // ==============================
  // 🧑‍🏫 EDUCATION / LMS
  // ==============================
  EDUCATION: ['COURSE_CREATED', 'COURSE_UPDATED', 'COURSE_PUBLISHED', 'COURSE_ENROLLED', 'COURSE_COMPLETED', 'LESSON_RELEASED', 'QUIZ_SUBMITTED', 'QUIZ_GRADED', 'CERTIFICATE_ISSUED'],

  // ==============================
  // 🏗️ PROJECT / TASK MANAGEMENT
  // ==============================
  PROJECT: ['PROJECT_CREATED', 'PROJECT_UPDATED', 'PROJECT_COMPLETED', 'MILESTONE_REACHED', 'MILESTONE_DELAYED', 'SPRINT_STARTED', 'SPRINT_COMPLETED', 'ISSUE_CREATED', 'ISSUE_RESOLVED', 'ISSUE_REOPENED'],

  // ==============================
  // 🤖 IOT / DEVICE OPERATIONS
  // ==============================
  IOT: ['DEVICE_REGISTERED', 'DEVICE_ONLINE', 'DEVICE_OFFLINE', 'DEVICE_ERROR', 'SENSOR_THRESHOLD_EXCEEDED', 'SENSOR_DATA_RECEIVED', 'FIRMWARE_UPDATE_AVAILABLE', 'FIRMWARE_UPDATE_COMPLETED', 'DEVICE_MAINTENANCE_REQUIRED'],

  // ==============================
  // 💼 CRM / CUSTOMER MANAGEMENT
  // ==============================
  CRM: ['LEAD_CREATED', 'LEAD_ASSIGNED', 'LEAD_CONVERTED', 'CUSTOMER_ESCALATED', 'CUSTOMER_FEEDBACK_RECEIVED', 'TICKET_CREATED', 'TICKET_RESOLVED', 'TICKET_ESCALATED', 'FOLLOWUP_REMINDER'],

  // ==============================
  // 🏭 ERP / SUPPLY CHAIN
  // ==============================
  ERP: ['PURCHASE_ORDER_CREATED', 'PURCHASE_ORDER_APPROVED', 'PURCHASE_ORDER_REJECTED', 'SUPPLIER_ADDED', 'SUPPLIER_REMOVED', 'PRODUCTION_STARTED', 'PRODUCTION_HALTED', 'INVENTORY_TRANSFERRED', 'DELIVERY_NOTE_ISSUED'],

  // ==============================
  // 🕹️ GAMIFICATION / USER ENGAGEMENT
  // ==============================
  GAMIFICATION: ['ACHIEVEMENT_UNLOCKED', 'LEVEL_COMPLETED', 'REWARD_CLAIMED', 'BADGE_AWARDED', 'CHALLENGE_ACCEPTED', 'CHALLENGE_COMPLETED', 'STREAK_CONTINUED', 'STREAK_BROKEN', 'LEADERBOARD_UPDATED'],

  // ==============================
  // 🛡️ SECOPS / SECURITY OPERATIONS
  // ==============================
  SECOPS: ['INTRUSION_DETECTED', 'UNAUTHORIZED_ACCESS_ATTEMPT', 'FIREWALL_RULE_CHANGED', 'MALWARE_QUARANTINED', 'PHISHING_ALERT', 'LOGIN_FROM_NEW_LOCATION', 'ADMIN_PRIVILEGE_ESCALATION', 'SECURITY_PATCH_APPLIED', 'THREAT_RESOLVED'],

  // ==============================
  // 🧩 CUSTOM / SYSTEM INTERNAL
  // ==============================
  CUSTOM: ['CUSTOM_EVENT', 'USER_DEFINED_EVENT1', 'USER_DEFINED_EVENT2', 'INTERNAL_TEST_TRIGGER', 'FEATURE_FLAG_UPDATED', 'EXPERIMENT_STARTED', 'EXPERIMENT_COMPLETED'],
};
