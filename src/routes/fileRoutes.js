...
const { uploadFiles, getFiles, getFileById, downloadFile, updateFileMetadata, replaceFileContent, deleteFile, getFileTransactions } = require('../controller/fileUploader/fileController');
...
// Upload routes
router.post('/upload', uploadLimiter, upload.array('files', 10), validateFile, validateUpload, uploadFiles);
...
router.put('/:id/replace', uploadLimiter, upload.single('file'), validateFile, replaceFileContent);
